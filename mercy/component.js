...
image.id = "temp_img_id";
image.className = "temp_img_class";
...
function previewFile() {
  ...
  var $container,
      ...
      min_height = 60,
      max_width = 1024, // Change as required
      max_height = 1024,
      resize_canvas = document.createElement('canvas');
      image_target.src= image.src;
     // alert("this should work"+image.src);
  ...
  crop = function(){
    ...
    base_image.onload=function(){
         ...
         ctx.drawImage(img,535,0);
    }  
  };
  down = function(){   
      var ctx = document.getElementById('canvas2');
      url=ctx.toDataURL("image/png");
     // alert("OK we...will download soon !!"+url)
